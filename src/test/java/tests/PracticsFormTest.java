...
public class PracticsFormTest {
  ...
  void fillFormTest() {
    ...
    $(".table-responsive").shouldHave(text("Alex"), text("Boyko"), text("boyko@yandex.ru"),
            text("Male"), text("9999999999"), text("23 May,1994"), text("English"), text("Music"),
            text("driver.jpg"), text("South Park"), text("Uttar Pradesh"), text("Merrut"));
